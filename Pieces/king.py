...
class King(Pieces.general_behaviour.GeneralBehaviour):
    def __init__(self, light, board, blockSize):
        super().__init__(light, board, blockSize)

        load_sprite = pygame.image
        if self.light:
            load_sprite = pygame.image.load("128px/w_king_png_shadow_128px.png")
        else:
            load_sprite = pygame.image.load("128px/b_king_png_shadow_128px.png")
