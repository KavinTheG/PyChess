...
class Bishop(GeneralPiece):
    def __init__(self, x, y, light, block_size):
        ...
        if self.light:
            load_sprite = pygame.image.load("assets/w_bishop_png_shadow_128px.png")
        else:
            load_sprite = pygame.image.load("assets/b_bishop_png_shadow_128px.png")
