...
class Castle(GeneralPiece):
    def __init__(self, x, y, light, block_size):
        ...
        if self.light:
            load_sprite = pygame.image.load("assets/w_rook_png_shadow_128px.png")
        else:
            load_sprite = pygame.image.load("assets/b_rook_png_shadow_128px.png")
    ...
    def get_legal_moves(self, board):
        ...
        # Tuples for direction left, up, right, down
